...
<?php 
            if ($prev_product_id != -1) { ShowLinkToProduct($prev_product_id, $cats_array, "PREVIOUS ", true); }
            if ($next_product_id != -1) { ShowLinkToProduct($next_product_id, $cats_array, "NEXT ", false); }
        }
        ?>
               </div>
