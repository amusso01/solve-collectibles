...
<section class="fd-woo__archive-anchor">
   ...
   <?php if($sub_cats)  : ?>
	<?php global $wp_query;  ?>
		...
		<?php else: ?>
			<a class="anchor-item" href="#teams-list">Category <span>        <?php get_template_part( 'svg-template/svg', 'down-arrow' ) ?></span></a>
		<?php endif; ?>
	<?php endif; ?>


<?php if($terms)  : ?>
        <a class="anchor-item" href="<?php echo $term_link ?>">Individual Product <span>        <?php get_template_part( 'svg-template/svg', 'right-arrow' ) ?></span></a>
<?php endif; ?>
