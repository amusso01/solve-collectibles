                            ...
                            <td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
                                <div class="product-name-flex">
                                    ...
                                    if ( ! $product_permalink ) {
                                        ...
                                        echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s"><span class="shortcode">'.$shortcode.' </span>%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key ) );
                                    }
                    ...
                    <td colspan="6" class="actions">
                        <div class="coupon-grid">
                            ...
                            <?php if ( wc_coupons_enabled() ) { ?>
                                <div class="coupon">
                                    <label for="coupon_code"></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Promotion Code', 'woocommerce' ); ?>" /> <button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply', 'woocommerce' ); ?></button>
                                    <?php do_action( 'woocommerce_cart_coupon' ); ?>
                                </div>
                            <?php } ?>

                            <button type="submit" class="button submit-button" name="update_cart" value="<?php esc_attr_e( 'Update Bag', 'woocommerce' ); ?>"><?php esc_html_e( 'Update Bag', 'woocommerce' ); ?></button>
